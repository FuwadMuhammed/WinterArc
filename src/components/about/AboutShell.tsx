...
import { getArcStartDate, getCurrentWeek } from "@/lib/arc-logic";
...
const CREDITS = [
  { name: "Akash", url: "https://www.linkedin.com/in/noakash/" },
  { name: "Ashfaqe", url: "https://www.linkedin.com/in/ashfaqe/" },
];
      ...
      <main className="mx-auto w-full max-w-5xl px-6 py-14">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="space-y-6">
              ...
              <dl className="mt-3 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <dd className="font-medium text-ink">
                    {userArc
                      ? getArcStartDate(userArc).toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                          year: "numeric",
                        })
            ...
            <div className="rounded-3xl border border-border bg-panel px-6 py-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-ink-faint">Thanks</p>
              <p className="mt-2 text-sm text-ink-muted">With thanks to the people who helped shape this.</p>
              <div className="mt-4 space-y-2.5">
                {CREDITS.map((person) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-sm text-ink-muted transition-check hover:text-ink"
                  >
                    <LinkedInIcon />
                    {person.name}
                  </a>
